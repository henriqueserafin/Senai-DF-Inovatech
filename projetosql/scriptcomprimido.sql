...
INSERT INTO diariobordo (texto, datahora, fk_Aluno_id) values ('nesta aula aprendemos comandos mais avançados de sql, como impedir valores duplicados, e como utilizar o join, ótima aula prof :)','2024-07-31 17:40:00','1');

INSERT INTO avaliacao (nota1, nota2, nota3, nota4, fk_Aluno_id) values ('25','25','25','25','1');

ALTER TABLE aluno
ADD nome varchar(80),
ADD tempoestudoint int,
ADD rendafamiliar decimal(10,2);


ALTER TABLE aluno
MODIFY tempoestudoint int NOT NULL;

ALTER TABLE aluno
CHANGE tempoestudoint tempoestudo int;
